...
public class Constants {
    ...
    public static final String customerPassword = "55555";
    public static final String customerAddress = "New York avenue";
    public static final String customerAddressLine = "Fifth Street";
    public static final String customerCity = "New York";
    public static final String customerState = "New York";
    public static final String customerPostCode = "11111";
    public static final String customerCountry = "United States";
    public static final String customerPhone = "05555555555";
    public static final String customerAddressAlias = "my formal address";
